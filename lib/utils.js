...
/**
 * Extracts all nested array values and returns a linear array.
 ...
 */
const mergeDedupeArray = (a, b) => (
  a.concat(b.filter(item => a.indexOf(item) < 0))
);
...
exports.mergeDedupeArray = mergeDedupeArray;
