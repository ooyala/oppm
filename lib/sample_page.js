...
const create = (destPath, fileName, resources, params) =>
  new Promise((resolve, reject) => {
    ...
    (resources || []).forEach((resource) => {
      ...
      switch (extname) {
        case '.js':
          pageConfig.scripts.push(buildRelativeResourcePath(resource));
          break;
        case '.json':
          pageConfig.json.push(buildRelativeResourcePath(resource));
          break;
        case '.css':
          pageConfig.styleSheets.push(buildRelativeResourcePath(resource));
          break;
        default:
          break;
      }
